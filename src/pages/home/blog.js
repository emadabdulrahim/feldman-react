...
const Post = ({ title, content, date, categories, link }) => (
  <li className={s.post_container}>
    <div className={s.post_wrapper}>
      <a
        className={s.link_absolute}
        href={link}
        target="_blank"
...
export default ({ feed, isFetching }) => (
  <AppContext.Consumer>
    {({ feed, isFetching }) => (
      <section className={s.section}>
        <div className={s.blog_background} />
        <div className={s.section_content}>
          <div className={s.section_intro}>
            <SectionSuperTitle>Psychology in 10 Minutes</SectionSuperTitle>
            <SectionTitle>
              Useful bite-sized pychology <br />
              <span className={s.muted}>While you sip your morning coffee</span>
            </SectionTitle>
            {console.log('feed: ', feed, isFetching)}
            <p className={s.section_blurb}>
              We all yearn to know more about ourselves and better understand
              the thoughts, feelings, and behaviors of the people we care about.
            </p>
            <div className={s.share}>
              <a className={s.social_icon} href="">
                <svg>
